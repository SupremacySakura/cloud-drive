    ...
    <div
        ...
        <header
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-100">云盘 -by supremacy</span>
            </div>
        </header>
            ...
            <div
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input id="username" v-model="form.username" name="username" type="text"
                                    placeholder="请输入唯一用户名" autocomplete="username"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative flex items-center">
                                <input id="password" v-model="form.password" name="password" :type="passwordInputType"
                                    placeholder="请创建一个强密码" autocomplete="new-password"
                ...
                <div
                    ...
                    <p class="text-slate-600 dark:text-slate-400">
                        已经有账号了？
                        <RouterLink class="text-primary font-bold hover:underline" to="/login">返回登录
                        </RouterLink>
                    </p>
                </div>
            </div>
