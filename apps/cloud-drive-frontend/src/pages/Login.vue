            ...
            <div
                    ...
                    <form class="space-y-5" @submit.prevent="onSubmit">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative flex items-center">
                                <input id="password" v-model="form.password" name="password" :type="passwordInputType"
                                ...
                                <button class="absolute right-3 text-slate-400 hover:text-primary transition-colors"
                                    ...
                                    <svg v-if="showPassword" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="none" class="w-5 h-5" aria-hidden="true">
                                        <path
                                    ...
                                    <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            d="M3 12C4.8 7.8 8.1 5.5 12 5.5C15.9 5.5 19.2 7.8 21 12C19.2 16.2 15.9 18.5 12 18.5C8.1 18.5 4.8 16.2 3 12Z"
                                            stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" />
                                        <path d="M9.6 14.4C9.03333 13.8333 8.7 12.9 8.8 12C8.9 11.1 9.2 10.4 9.6 9.6"
                                            stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
                                        <path d="M4.5 4.5L19.5 19.5" stroke="currentColor" stroke-width="1.8"
                ...
                <div
                    ...
                    <p class="text-slate-600 dark:text-slate-400">
                        还没有账号？
                        <RouterLink class="text-primary font-bold hover:underline" to="/register">立即注册</RouterLink>
                    </p>
                </div>
            </div>
        </main>
